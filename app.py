...
html, body, [class*="css"] { font-family: 'Noto Sans KR', sans-serif; background: #F4F1EC; }
#MainMenu, footer, header { visibility: hidden; }

/* 사이드바 */
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #1C1A18 0%, #2A2826 100%) !important;
...
.banner-season { font-size: 11px; opacity: .85; letter-spacing: .1em; margin-bottom: 4px; text-transform: uppercase; }
.banner-title { font-family: 'Nanum Myeongjo', serif; font-size: 24px; font-weight: 800; margin-bottom: 2px; }
.banner-subtitle { font-size: 13px; opacity: .75; font-style: italic; margin-bottom: 4px; }
...
.heal-card {
    ...
    border: 1px solid #E0DDD8; padding: 18px 20px;
    margin-bottom: 14px;
...
.poem-card:hover { box-shadow: 0 2px 12px rgba(0,0,0,.08); }
.poem-num { font-size: 11px; font-weight: 600; color: #9B9591; letter-spacing: .06em; margin-bottom: 8px; }
.poem-text {
    font-family: 'Nanum Myeongjo', serif;
    font-size: 14px; line-height: 2.2; color: #1C1A18;
    white-space: pre-line; margin-bottom: 12px;
    padding-bottom: 12px; border-bottom: 1px dashed #E0DDD8;
}
.poem-meaning { font-size: 12.5px; color: #6B6560; line-height: 1.8; white-space: pre-line; }

/* 안내박스 */
.notice-box {
    background: #FFF8E7; border: 1px solid #FFD966;
    border-radius: 10px; padding: 12px 14px;
    font-size: 13px; color: #7A5800; margin-bottom: 12px; line-height: 1.7;
}
...
.step-text { font-size: 13.5px; line-height: 1.5; font-weight: 500; }
.step-tip { font-size: 11.5px; color: #9B9591; font-style: italic; margin-top: 2px; }

/* 시작 문장 */
.starter-box {
    background: #F7F5F0; border: 1.5px dashed #C8C4BF;
    border-radius: 10px; padding: 14px 16px;
    font-size: 13.5px; line-height: 1.85;
    white-space: pre-line; color: #1C1A18;
...
.q-item:hover { box-shadow: 0 2px 8px rgba(0,0,0,.07); }
.q-badge { font-size: 10px; font-weight: 600; padding: 2px 8px; border-radius: 10px; white-space: nowrap; flex-shrink: 0; }

/* 섹션 구분선 */
.section-divider {
    border: none; border-top: 2px solid #EAE6E0; margin: 24px 0;
}
</style>
